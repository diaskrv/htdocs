...
<?php
  ...
  $sqlSelect = "SELECT * FROM products WHERE category='study' ORDER by brand ASC";
  ...
  if(isset($_POST["add_to_cart"]))
 {
      if(isset($_SESSION["shopping_cart"])){
           ...
           else
           {
                ...
                echo '<script>window.location="srudylap.php.php"</script>';
           }
      }
      else
      {
  ...
  <div class="categories1">
    <div class="small-container">
      <div class="row">
        ...
        ?>
        <div class="col-4">
          <form method="post" action="studylap.php?action=add&id=<?php echo $row["id"];?>">
              ...
              <div class="modal-body">
                  <table class="table">
                      ...
                      <tr>
                          ...
                          <td style="color: red;"><a href="studylap.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
                      </tr>
                      <?php
