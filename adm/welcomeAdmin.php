...
@keyframes fadeIn {
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <a href="prodPage/applemac.php">
                  <img src="../assets/appleFeatProd.jpg" style="width: 1230px; height: 630px; margin-left: 240px;">
                </a>
              ...
              <div class="carousel-item">
                <a href="prodPage/asus.php">
                  <img src="../assets/asusFeatProd.jpg" style="width: 1230px; height: 630px; margin-left: 240px;">
                </a>
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item">
                <a href="prodPage/log.php">
                  <img src="../assets/logitechFeatProd.jpg" style="width: 1230px; height: 630px; margin-left: 240px;">
                </a>
                <div class="carousel-caption d-none d-md-block">
              ...
              <div class="carousel-item">
                <a href="prodPage/beyer.php">
                  <img src="../assets/beyerdynamicFeatProd.jpg" style="width: 1230px; height: 630px; margin-left: 240px;">
                </a>
                <div class="carousel-caption d-none d-md-block">
  ...
  <h2 class="u-custom-font u-font-titillium-web u-text u-text-white u-text-1" style="  margin: 0 auto 80px; text-align: center; margin-top: 40px;">List of electronic devices store</h2>
    <div class="row">
      <div id="map"></div>
    </div>
